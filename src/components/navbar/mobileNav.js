  ...
  return (
    ...
    >
      <div
        ...
        className={`flex text-7xs flex-col space-y-1.5 items-center ${location.pathname == "/" ? "text-red-500" : "text-white"
          }`}
      >
      ...
      <div
        ...
        className={`flex text-7xs space-y-1 flex-col items-center ${location.pathname == "/about" ? "text-red-500" : "text-white"
          }`}
      >
      ...
      <div
        ...
        className={`flex text-7xs space-y-1 flex-col items-center ${location.pathname == "/rr-lxt-rink" ? "text-red-500" : "text-white"
          }`}
      >
        ...
        {openMenu && (
          <div className="absolute bottom-[50px] rounded-b-xl rounded-tl-xl right-0 bg-card-color h-40 w-40 flex flex-col pt-2">
            <span
              ...
              className={`p-2 px-4 ${location.pathname == "/announcement"
                  ? "text-red-500 "
                  : "text-white"
                }`}
            >
            ...
            <span
              ...
              className={`p-2 px-4 ${location.pathname == "/achievement"
                  ? "text-red-500 "
                  : "text-white"
                }`}
            >
            ...
            <span
              ...
              className={`p-2 px-4 ${location.pathname == "/news" ? "text-red-500 " : "text-white"
                }`}
            >
              Media
            </span>
            <span
              ...
              className={`p-2 px-4 ${location.pathname == "/contact" ? "text-red-500 " : "text-white"
                }`}
            >
              Contact Us
            </span>
